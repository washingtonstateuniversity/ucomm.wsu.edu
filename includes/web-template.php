		...
		<main class="spine-page-default">
			<header class="ucomm-bookmark">
				<hgroup>
					...
					<div class="site"><a href="<?php home_url(); ?>" title="<?php echo esc_attr( $site_name ); ?>" rel="home">Design and Printing Services <!--<span class="addGray">Communications</span>--></a></div>
