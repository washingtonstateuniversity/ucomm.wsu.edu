...
class research_lib {
	...
	public function __construct() {
		...
		add_shortcode( 'research_lib',    array( $this, 'research_lib_display' ) );
	}
	 ...
	 */
	public function research_lib_display() {
		// Build the output to return for use by the shortcode.
		ob_start();
		?>
 <section class="lib-work">
    <?php 
      $thumbnails = get_posts(array('posts_per_page' => 9,'tag' => 'research'));
